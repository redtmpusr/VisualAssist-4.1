...
public class GrenadeThrowPrefixPatch : ModulePatch
{
    ...
    public static bool Prefix(
        Player.BaseGrenadeHandsController __instance, Player ____player, Transform ___patronInWeaponTransform, bool lowThrow, float timeSinceSafetyLevelRemoved,
    ...
    )
    {
        ...
        __instance.ThrowGrenade(
            timeSinceSafetyLevelRemoved, grenadeArc.GrenadeThrow.ThrowPosition, ___patronInWeaponTransform.rotation, grenadeArc.GrenadeThrow.ThrowForce, lowThrow
        );
